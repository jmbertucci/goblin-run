...
(function (GoblinRun) {
    var Game = (function (_super) {
        ...
        function Game() {
            ...
            this.state.add("Menu", GoblinRun.Menu);
            // start
...
(function (GoblinRun) {
    ...
    var MainLayer = (function (_super) {
        ...
        function MainLayer(game, parent) {
            _super.call(this, game, parent);
            this._timeForGold = MainLayer.GOLD_COUNTER_MIN;
            ...
            // pool of items
            this._itemsPool = new Helper.Pool(Item, 32, function () {
                // empty item
            ...
            if (recordDistance > 0) {
                var record = new GoblinRun.Record(game, this, recordDistance);
                this.add(record);
            }
            // emitters
        ...
        MainLayer.prototype.addTiles = function (x, y, type, platform, spike) {
            ...
            for (var r = y; r < y + rowsCount; r++) {
                ...
                if (spike && r === y) {
                    ...
                    this.setupItem(spikeSprite, GoblinRun.BlockDefs.SPIKES, true, true);
...
(function (GoblinRun) {
    var Player = (function (_super) {
        ...
        function Player(game) {
            _super.call(this, game, 0, 0, "Sprites", "Empty");
            ...
            var bodyOffsetX = -bodyW / 2 + this.width * this.anchor.x;
            var bodyOffsetY = 0;
...
(function (GoblinRun) {
    var ScoreUI = (function (_super) {
        ...
        function ScoreUI(game, parent) {
            ...
            this.add(this._icon);
            // text
            this._text = new Phaser.BitmapText(game, this._icon.width / 2 * 1.2, 0, "Font", "0", 40, "left");
...
(function (GoblinRun) {
    var Shadow = (function (_super) {
        ...
        function Shadow(game, playerPosition, walls) {
            _super.call(this, game, 0, 0, "Sprites", "Shadow");
...
(function (GoblinRun) {
    var Boot = (function (_super) {
        ...
        function Boot() {
            _super.apply(this, arguments);
            this._userScale = new Phaser.Point(1, 1);
...
(function (GoblinRun) {
    var Menu = (function (_super) {
        ...
        Menu.prototype.create = function () {
            ...
            this.sound.mute = !GoblinRun.Preferences.instance.sound;
...
(function (GoblinRun) {
    var Play = (function (_super) {
        ...
        Play.prototype.create = function () {
            ...
            // score UI on screen
            this._scoreUI = new GoblinRun.ScoreUI(this.game, this.world);
